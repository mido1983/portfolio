...
export function Navbar() {
  return (
    <header className="sticky top-0 z-50 backdrop-blur">
      <div className="container-grid flex flex-wrap items-center gap-4 py-4 md:flex-nowrap md:justify-between md:gap-6 md:py-6">
        <Link href="/" className="order-1 w-full text-lg font-semibold tracking-tight md:w-auto">
          {siteConfig.name}
        </Link>
        <div className="order-2 flex w-full flex-wrap items-center gap-3
                justify-center
                md:order-3 md:w-auto md:flex-nowrap">
          <motion.a
        ...
        <nav className="order-3 hidden w-full gap-6 text-sm font-medium md:order-2 md:flex md:w-auto">
          {navLinks.map((link) => (
